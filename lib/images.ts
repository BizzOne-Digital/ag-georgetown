...
export const FRAGRANCE_BESTSELLER_SAUVAGE: SiteImage = { src: "/images/fragrance/8.jpg", alt: "Gold-capped perfume bottle wrapped in sheer fabric with soft bokeh lighting" };
...
export const MAKEUP_FACE_2: SiteImage = { src: "/images/makeup/aaaa.jpg", alt: "Foundation, concealer, and mascara flatlay on beige with a palm leaf and smudged swatches" };
